...
const ProfileReviewsVideo = () => {
  return (
    <div className=" mx-auto bg-white rounded-lg border border-gray-200 p-4 mt-10">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold">My Reviews</h2>
        <select className="outline-none text-white bg-gray-200 hover:bg-gray-100 px-4 py-2 rounded-lg text-sm font-medium cursor-pointer">
